...
Q1 = simulate_gr4j(nStep, x1, x2 * 1.3, x3 * 1.2, x4, upperTankRatio, lowerTankRatio, maxDayDelay, UH1, UH2, Pn, En)
Q2 = simulate_gr4j(nStep, x1, x2 * 0.8, x3 * 1.5, x4, upperTankRatio, lowerTankRatio, maxDayDelay, UH1, UH2, Pn, En)
...
# result = differential_evolution(objective_function, bounds, strategy='rand2bin', popsize=10, maxiter=100, mutation=(0.6, 1.0), recombination=0.95, seed=42)
best_params = result.x

print("差分进化优化后的参数:", best_params)

# 用优化后的参数运行GR4J模型
Q1 = simulate_gr4j(nStep, best_params[0], best_params[1], best_params[2], best_params[3], upperTankRatio, lowerTankRatio, maxDayDelay, UH1, UH2, Pn, En)
NSE_optimized = evaluate_gr4j_model(nStep, Qobs_mm, Q1, plot=True)
...
# 用优化后的参数运行GR4J模型
Q2 = simulate_gr4j(nStep, best_params[0], best_params[1], best_params[2], best_params[3], upperTankRatio, lowerTankRatio, maxDayDelay, UH1, UH2, Pn, En)
NSE_optimized = evaluate_gr4j_model(nStep, Qobs_mm, Q2, plot=True)
